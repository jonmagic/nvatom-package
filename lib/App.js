...
var App = {
  ...
  start: function() {
    ...
    this.documentList.initialize({path: atom.project.path, extensions: [".md"]});
    ...
    var documentList = this.documentList,
        searchBar = this.searchBar;

    searchBar.model().onDidStopChanging(function() {
      documentList.search(searchBar.model().getText());
    });
  },
