...
// Public: DocumentLoader takes a path and an object with update and remove
...
//     }
//
//   > new DocumentLoader(path, [".md"], callbacks);
...
//
// Returns an Object.
var DocumentLoader = function(path, extensions, callbacks) {
  this.path = path;
